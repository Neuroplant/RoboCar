...
#define SERVOGX_MIN_MS 5+OFFSET_MS        
#define SERVOGX_MAX_MS 25+OFFSET_MS       
#define SERVOGY_MIN_MS 5+OFFSET_MS        
#define SERVOGY_MAX_MS 25+OFFSET_MS       
#define SERVOGZ_MIN_MS 5+OFFSET_MS        
#define SERVOGZ_MAX_MS 25+OFFSET_MS  
...
void *GimbalThread (void *value) {
	...
	while (run) {
		...
		servoWriteMS(servoPin_GX,map(ax,-AccelMax  ,AccelMax  ,SERVOCX_MIN_MS,SERVO_MAX_MS));
		servoWriteMS(servoPin_GY,map(ay,-AccelMax  ,AccelMax  ,SERVOGX_MIN_MS,SERVO_MAX_MS));
		servoWriteMS(servoPin_GZ,map(az,-AccelMax  ,AccelMax  ,SERVOGY_MIN_MS,SERVO_MAX_MS));
	}
}
